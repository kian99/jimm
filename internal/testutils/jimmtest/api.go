...
func (a *API) ControllerConfig(ctx context.Context) (jujuparams.ControllerConfigResult, error) {
	if a.ControllerConfig_ == nil {
		return jujuparams.ControllerConfigResult{}, errors.New("").WithCode(errors.CodeNotImplemented)
	}
...
func (a *API) LatestLogTime(modelUUID string) (time.Time, error) {
	if a.LatestLogTime_ == nil {
		return time.Time{}, errors.New("").WithCode(errors.CodeNotImplemented)
	}
...
func (a *API) UpgradeModel(modelUUID string, targetVersion version.Number, stream string, ignoreAgentVersions bool, dryRun bool) (version.Number, error) {
	if a.UpgradeModel_ == nil {
		return version.Number{}, errors.New("").WithCode(errors.CodeNotImplemented)
	}
