...
func (j *ModelManager) GetModel(ctx context.Context, uuid string) (dbmodel.Model, error) {
	if j.GetModel_ == nil {
		return dbmodel.Model{}, errors.New("").WithCode(errors.CodeNotImplemented)
	}
...
func (j *ModelManager) ModelDefaultsForCloud(ctx context.Context, user *dbmodel.Identity, cloudTag names.CloudTag) (jujuparams.ModelDefaultsResult, error) {
	if j.ModelDefaultsForCloud_ == nil {
		return jujuparams.ModelDefaultsResult{}, errors.New("").WithCode(errors.CodeNotImplemented)
	}
...
func (j *ModelManager) ListModelSummaries(ctx context.Context, u *openfga.User, maskingControllerUUID string) (jujuparams.ModelSummaryResults, error) {
	if j.ListModelSummaries_ == nil {
		return jujuparams.ModelSummaryResults{}, errors.New("").WithCode(errors.CodeNotImplemented)
	}
...
func (j *ModelManager) QueryModelsJq(ctx context.Context, models []string, jqQuery string) (params.CrossModelQueryResponse, error) {
	if j.QueryModelsJq_ == nil {
		return params.CrossModelQueryResponse{}, errors.New("").WithCode(errors.CodeNotImplemented)
	}
